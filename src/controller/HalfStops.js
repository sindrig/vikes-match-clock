...
const HalfStops = ({
    halfStops, updateHalfLength, matchType, setHalfStops,
}) => {
    ...
    return (
        <React.Fragment>
            <div>
                Klukkustopp:
                <select onChange={({ target: { value } }) => value && setHalfStops(autoHalfStops[value])} value="">
...
const stateToProps = ({ match: { halfStops, matchType } }) => ({ halfStops, matchType });
