...
class Clock extends Component {
    ...
    updateTime() {
        const {
            started, halfStop, timeElapsed, pauseMatch,
        } = this.props;
...
const stateToProps = ({
    match: {
        started, halfStops, timeElapsed, matchType, pauseMatch,
    },
}) => ({
    started, timeElapsed, matchType, pauseMatch, halfStop: halfStops[0],
});
